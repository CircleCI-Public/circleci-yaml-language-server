...
func TestYamlDocument_parseExecutors(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: map[string]ast2.Executor{
				"docker-executor": ast2.DockerExecutor{
					...
					Image: []ast2.DockerImage{
						{
							Image: ast2.DockerImageInfo{
								Namespace: "cimg",
								Tag:       "3.0.3-browsers",
								Name:      "ruby",
				...
				"machine-executor": ast2.MachineExecutor{
					Image: "ubuntu-2004:current",
					ImageRange: protocol.Range{
						Start: protocol.Position{
							Line:      12,
				...
				"macos-executor": ast2.MacOSExecutor{
					BaseExecutor: ast2.BaseExecutor{
						Name: "macos-executor",
						NameRange: protocol.Range{
							Start: protocol.Position{
						...
						UserParameters: map[string]ast2.Parameter{
							"dummyParam": ast2.StringParameter{
								Default: "dummy",
