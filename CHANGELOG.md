...
* added quickfix on deprecated attribute (version: 2 in workflow) ([1207f45](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/1207f45b308d0309ed11e0f684cbcd1105835723))
* added quickfix on outdated orb ([c471a07](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/c471a071adccff562313163cb0be462c73b2066f))
...
* autocomplete orb names ([ad9951d](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/ad9951d7489f6062fb600f2bf16820934cacf83b))
...
* **bin/start_server:** `--stdio` parameter replaced by `stdio` command ([30a75e7](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/30a75e78871334dcb53dc308a1f74231f114c0f1))
...
* **product:** not marking `machine=true` as deprecated on hosted instance ([b5e4dd9](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/b5e4dd9ae136619aa5ee62e0a05c65fa939c58ba))
* Proper verification of field `require` inside the `workflow` field ([1282fc9](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/1282fc9acd2364dfa19215e22c499e5f30e20b33))
* Replace messages "Must validate one and only one schema (oneOf)" with a more meaningful one ([bd8675d](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/bd8675d9500d026b83d02cd3ae2ed58153268b53))
* **start server CLI:** add `--port` and `--host` options ([41405f8](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/41405f8a52ff269908468f882f8a41e533354848))
* **start server CLI:** add `--schema` option ([21652da](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/21652dac47387be79fae5029cd38977824140e4c))
* Support for anchors/alias ([8114c7c](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/8114c7c531d51db59e3f689bdbc9af12d1ec6d15))
* support for merge keys ([#71](https://github.com/CircleCI-Public/circleci-yaml-language-server/issues/71)) ([6c17cff](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/6c17cff1f26c9d0cd1c4389e29322e1cc3869882))
* Support of anchor/alias inside steps reference ([6fdedaa](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/6fdedaa217638af19c5562d36349dc10109fd14a))
...
* tags autocomplete for docker images ([97c3957](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/97c39571101083bc79a6d00d3c90f45047807afb))
* tags autocomplete for docker images ([1d86b23](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/1d86b2380dfad0869e696128fbc68a84592e2b44))
...
* Validating the `when` field inside the run command ([4fa51d9](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/4fa51d9cfb75dff0a33f5742979d858282ba2887))
...
* anchor defined in job executor names are now valid ([#51](https://github.com/CircleCI-Public/circleci-yaml-language-server/issues/51)) ([8986d6d](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/8986d6d269ba5c57e9817a1755109e329c2cb5f6))
...
* commands used as post- or pre-steps were are now detected as being used ([5b56701](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/5b5670127e38d0e1e371000f7111f3df9ad29282))
* Default executor being validated even if not set ([39c05a0](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/39c05a02cc9cc194497524f3edb59da73406c2f7))
...
* Do not check docker image if a parameter is referenced inside the image's tag ([a726394](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/a7263945296f284b1f94a83d3471d81ff6421d0c))
...
* fix "docker" keyword colour anomaly ([27b1930](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/27b193027abe72b99cd51ae977b49a7643280f05))
* Fix "Parameter is not defined" even though it is and go-to-def works ([eabafdb](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/eabafdb25edf6c29594b1a6c26a3d72b5b14c319))
...
* Fix a bug where the LS would crash when parsing parameters that does not have the right type ([64383a7](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/64383a7dbff77680fa5cf70dbe665afbfae1bcbb))
...
* Fix error when step parameter doesn't have a value ([20068f1](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/20068f1f89c74a61d3a1aeacd1831ac5371377eb))
* Fix executor inside default field in parameter declaration being marked as invalid ([8f18f11](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/8f18f11c6e3753f0bade2f040b8d2faed17a6ec3))
...
* Fix invalid executor as being wrong orb's executor ([579fea4](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/579fea4a9730d6c8e5569ca746f574d247afc54f))
* fix job alias not recognised ([9081eda](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/9081eda4518a985545053bff92cb33c18595b8e7))
...
* Fix orb caching issue ([fb998ea](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/fb998ea136e7e82373f2334676fbb679b8210f44))
...
* Fix step reference marking the whole file as an error ([1aca5c0](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/1aca5c094277af54b49dd2e960331cb006c6fdc6))
* fix user agent not being the right one ([17526e5](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/17526e5f938b946886de79ee80790a20daed7e6b))
* Fixed a bug where the language server would crash at startup ([0ea9d73](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/0ea9d73281210e7f814234271ff5c3f873e62b86))
* fixed diagnostic where orb version had to be a valid semver ([2600498](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/26004982a468d5bd907c1088f446aea2a0e5227b))
...
* fixed incorrect suggestion "A new major version exists" when using a non-semver orb version ([b2b162e](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/b2b162ea17d4367d137fcc8ea2220924d4ce2776))
...
* fixed invalid syntax validation for parameter entered in-line ([fabc832](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/fabc8326dbb30d051e3a8f407590dff3716e7abe))
* fixed stdio option ([76a462b](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/76a462bf8a5715f1411bc4b08744410acda390da))
...
* Fixed various problems involved with anchors/aliases ([5ffcf20](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/5ffcf20db814161113a38fd9d41ef4708a6e0b31))
...
* No more false errors on self hosted runners ([ffc9f47](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/ffc9f47c7a5fa0358e103c007d9fcff60dd1496c))
* Orb go to definition not working properly when the cached orb file is replaced ([09e2f4c](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/09e2f4c5d8c76e2804243c5b4d95feca930c30f4))
...
* **product:** `machine: true` not marked as deprecated on self-hosted runners ([28f0df5](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/28f0df55f6fc4470ffbfcbcace571584bc635632))
...
* raise an error if an undeclared parameter is passed to a job/command ([641a3c0](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/641a3c08a07bcfed875cd2e1d72af6720a1555bc))
* Refacto the way orb version errors are shown to not use too much space ([c670ea9](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/c670ea9a454b92b37ada048a803226d0f1dea4b4))
...
* remove orb cache on token change ([bb8f0c0](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/bb8f0c0b188e6ff0d7afcabf27c4f8ef52398159))
...
* Silence errors when closing a file of a downloaded orb ([0b5687b](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/0b5687b2aa34c2bcccb56f2bd2bf0b970e90b406))
...
* string values for step type parameters must be existing command name ([#81](https://github.com/CircleCI-Public/circleci-yaml-language-server/issues/81)) ([b62c797](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/b62c7977fc2907de5c6fe30cc2d0134d8bce4a30))
* Support of multiline parameter values ([f3c14a4](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/f3c14a4937e67611b52ffca67ca7167ed4b6d897))
...
* updated supported ubuntu images ([7b356cb](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/7b356cbee34f5c38d6e566fa7cde5f105a10cecd))
* Updated supported xcode version ([48bcfda](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/48bcfdaf8c8b7945d92279ba54832b05827c0ada))
* Updated supported Xcode versions ([29f3fb2](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/29f3fb26f1407181ca7b5f50ff6a9fa522007568))
* warnings for empty (top-level) params,execs,orbs,commands ([#40](https://github.com/CircleCI-Public/circleci-yaml-language-server/issues/40)) ([db901c9](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/db901c9e526be798e90416b757b8ca1aae96dc41))
* When an unknown anchor is referenced, the error won't appear anymore everywhere the name of the anchor is written ([b0fdfc5](https://github.com/CircleCI-Public/circleci-yaml-language-server/commit/b0fdfc5f8614e53db78f3149751a55982f09b46c))
